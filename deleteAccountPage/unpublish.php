...
<?php
    ...
    echo "<div class='container'><h1 class='text-success mt-5'>Site ".$sitename." has been Unpublished!</h1></div>";    
?>
<?php else: ?>
    <div class="container">      
        <div class="row">            
            <div class="col-12 col-sm-6 col-md-6 col-lg-6 py-5 mx-auto d-block">
                <div class="card">
                    <h5 class="card-header special-color white-text py-4" lang="en">Unpublish site</h5>
                    <div class="card-body px-lg-5 pt-5">                
                        <form style="color: #757575;" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                            ...
                            <button class="btn btn-success btn-rounded btn-block my-4 z-depth-0" type="submit" lang="en">Unpublish</button> 
                        </form>
                    </div>
                </div>
            </div>
