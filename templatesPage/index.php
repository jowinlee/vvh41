	...
	<div class="d-flex" id="wrapper">
    	<div class="bg-light border-right" id="sidebar-wrapper">
      		...
      		<div class="list-group list-group-flush" id="templateTab" role="tablist">
                ...
                <a class="list-group-item" data-toggle="tab" href="#destination" role="tab" aria-controls="destination">Landing Page</a>
                <a class="list-group-item" data-toggle="tab" href="#prof" role="tab" aria-controls="prof">Professional Services</a>
                <a class="list-group-item" data-toggle="tab" href="#restau" role="tab" aria-controls="restau">Food and Nutrition</a>
                <a class="list-group-item" data-toggle="tab" href="#vide" role="tab" aria-controls="vide">Empty</a>
                <a class="list-group-item" data-toggle="tab" href="#boutique" role="tab" aria-controls="boutique">Online Store</a>
                <a class="list-group-item" data-toggle="tab" href="#evenements" role="tab" aria-controls="evenements">Events</a>
                <a class="list-group-item" data-toggle="tab" href="#folio" role="tab" aria-controls="folio">Portfolio and CV</a>
                <a class="list-group-item" data-toggle="tab" href="#art" role="tab" aria-controls="art">Art of Living and Health</a>
                <a class="list-group-item" data-toggle="tab" href="#voyages" role="tab" aria-controls="voyages">Travelling</a>
                <a class="list-group-item" data-toggle="tab" href="#education" role="tab" aria-controls="education">Community and Education</a>
