    ...
    <div class="container">      
        <div class="row">
            ...
            <div class="col-12 col-sm-6 col-md-6 col-lg-6 py-5">
                <div class="card">
                    <h5 class="card-header special-color white-text py-4" lang="en">Enter User Account</h5>
                    <div class="card-body px-lg-5 pt-5">                
                        <form style="color: #757575;" action="processTemplate.php" method="post">
                            ...
                            <button class="btn btn-success btn-rounded btn-block my-4 z-depth-0" type="submit" lang="en">Create site</button> 
                            <a href="index.php"><small lang="en">Back to templates</small></a>            
                        </form>
                    </div>
                </div>
            </div>
