            ...
            <div class="row mx-0">
                <div class="col-6 col-sm-6 col-md-3 col-lg-3 col-xl-3 p-2">
                    <div class="card">
                        ...
                        <p class="text-center"><a data-ms-membership="5f187cc6374769000482de6c" href="signup.php" class="btn btn-elegant"> Subscribe </a><br>Free 15 Days Trial!</p>
                ...
                <div class="col-6 col-sm-6 col-md-3 col-lg-3 col-xl-3 p-2">
                    <div class="card">
                        ...
                        <p class="text-center"><a data-ms-membership="5f12c0923b974a0004c9a504" href="signup.php" class="btn btn-elegant"> Subscribe </a><br>Free 15 Days Trial!</p>
                ...
                <div class="col-6 col-sm-6 col-md-3 col-lg-3 col-xl-3 p-2">
                    <div class="card">
                        ...
                        <p class="text-center"><a data-ms-membership="5f12c0f7169e140004728a68" href="signup.php" class="btn btn-elegant"> Subscribe </a><br>Free 15 Days Trial!</p>
            ...
            <div class="row mx-0">
                <div class="col-6 col-sm-6 col-md-3 col-lg-3 col-xl-3 p-2">
                    <div class="card">
                        ...
                        <p class="text-center"><a data-ms-membership="5f12c015705fe10004a81a47" href="signup.php" class="btn btn-elegant"> Subscribe </a><br> Free 15 Days Trial!</p>
                        <?php include('../plans_page/personnel.php');?>
                ...
                <div class="col-6 col-sm-6 col-md-3 col-lg-3 col-xl-3 p-2">
                    <div class="card">
                        ...
                        <p class="text-center"><a data-ms-membership="5f12c0518385a50004513f1f" href="signup.php" class="btn btn-elegant"> Subscribe </a><br> Free 15 Days Trial!</p>
                        <?php include('../plans_page/entreprise.php');?>
                ...
                <div class="col-6 col-sm-6 col-md-3 col-lg-3 col-xl-3 p-2">
                    <div class="card">
                        ...
                        <p class="text-center"><a data-ms-membership="5f12c0bf169e140004728a67" href="signup.php" class="btn btn-elegant"> Subscribe </a><br> Free 15 Days Trial!</p>
                        <?php include('../plans_page/commerce_basic.php');?>
                ...
                <div class="col-6 col-sm-6 col-md-3 col-lg-3 col-xl-3 p-2">
                    <div class="card">
                        ...
                        <p class="text-center"><a data-ms-membership="5f12c129dfeab6000466d92e" href="signup.php" class="btn btn-elegant"> Subscribe </a><br> Free 15 Days Trial!</p>
                        <?php include('../plans_page/commerce_avance.php');?>
