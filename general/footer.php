	...
	<footer class="page-footer font-small elegant-color" style="margin-top: 50px; background: #000; color: #fff;">
      <div class="container py-5">
      	<div class="row">
      		...
      		<div class="col">
      			...
      			<ul class="list-inline">
      				<li class="list-inline-item"><a href="https://twitter.com/VVH_Pro"><i class="fab fa-twitter fa-2x"></i></a></li>
      				<li class="list-inline-item"><a href="https://www.youtube.com/user/UCCQNrlL_g5JiJLSu3k_cBmA"><i class="fab fa-youtube fa-2x"></i></a></li>
      			</ul>      			
      		</div>
      	</div>
      </div>
